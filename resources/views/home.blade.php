<x-app-layout>
    <x-slot name="header">
        ...
        <a href="{{ route('route.create') }}" class="btn btn-primary mt-2 form-control flex items-center">
            <span class="ml-2">Añadir ruta</span>
        ...
        <div class=" col-12 col-md-6">
            ...
            <div class="flex">
                ...
                <button type="submit" class="text-primary flex items-center">
                    Buscar
        ...
        <a href="{{ route('home') }}" class="text-primary flex items-center">Ultimas </a>
        <span class="separator">|</span>
        <a href="{{ route('home.likes') }}" class="text-primary flex items-center">Mas gustadas<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
        ...
        <span class="separator">|</span>
        <a href="{{ route('home.comments') }}" class="text-primary flex items-center">Mas comentadas<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-left-text" viewBox="0 0 16 16">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-4">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="col-6">
                            ...
                            <a href="{{ route('route.show', ['id' => $route->id]) }}" class="text-primary">
                                <span>
